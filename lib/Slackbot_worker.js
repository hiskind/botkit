...
module.exports = function(botkit, config) {
     ...
     */
    bot.startPrivateConversation = function(message, options, cb) {
        if (typeof options === 'function') {
            cb = options;
            options = null;
        }
        botkit.startTask(this, message, options, function(task, convo) {
    ...
    bot.startConversation = function(message, options, cb) {
        botkit.startConversation(this, message, options, cb);
    };
        ...
        if (message.type == 'message' || message.type == 'slash_command' ||
            ...
            for (var t = 0; t < botkit.tasks.length; t++) {
                for (var c = 0; c < botkit.tasks[t].convos.length; c++) {
                    ...
                    if (convo.options && convo.options.type === 'channel') {
                        is_conv_found = convo.isActive() &&
