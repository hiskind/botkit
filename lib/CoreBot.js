...
function Botkit(configuration) {
    ...
    function Conversation(task, message, options) {
    ...
    function Task(bot, message, botkit) {
        ...
        this.startConversation = function(message, options) {
            var convo = new Conversation(this, message, options);
    ...
    botkit.startConversation = function(bot, message, options, cb) {
        if (typeof options === 'function') {
            cb = options
            options = null
        }
        botkit.startTask(bot, message, options, function(task, convo) {
            cb(null, convo);
        });
    };
    ...
    botkit.startTask = function(bot, message, options, cb) {
        if (typeof options === 'function') {
            cb = options;
            options = null;
        }
        ...
        var convo = task.startConversation(message, options);
